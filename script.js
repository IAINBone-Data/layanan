/**
 * File: script.js
 * PERUBAHAN: Kode dari forms.js telah digabungkan ke dalam file ini
 * untuk menghilangkan error 'import' dan 'module'.
 */

// ===================================================================================
// KODE YANG SEBELUMNYA ADA DI forms.js
// ===================================================================================
        ...
        Promise.allSettled([layananPromise, infoPromise])
            .then((results) => {
                ...
                if (layananSuccess && infoSuccess) {
                    ...
                    const itemToCache = {
                        data: { layanan: freshLayananData, info: freshInfoData },
                        timestamp: Date.now()
                    };
